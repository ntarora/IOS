//
//  MyTheatersWebViewController.swift
//  MoviesILike
//
...
class MyTheatersWebViewController: UIViewController, UIWebViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        let locationEnteredWithNoSpaces = location!.stringByReplacingOccurrencesOfString(" ", withString: "+", options: [], range: nil)
        // Do any additional setup after loading the view.
        let url = "http://google.com/movies?near=\(locationEnteredWithNoSpaces)"
